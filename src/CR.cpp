...
int main(int argc, char* argv[]){
    ...
    // // setup gfx
    auto gameL = CR::Gfx::createRenderLayer(CR::Gfx::getSize(), CR::Gfx::RenderLayerType::T_3D, "world", true, CR::Gfx::RenderLayers::GAME);
    auto uiL = CR::Gfx::createRenderLayer(CR::Gfx::getSize(), CR::Gfx::RenderLayerType::T_2D, "ui", true, CR::Gfx::RenderLayers::UI);
